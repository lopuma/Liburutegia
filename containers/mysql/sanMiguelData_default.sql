...
CREATE TABLE `books` (
  ...
  `numReference` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`bookID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `users` VALUES (1,'admin@mail.com','ADMIN','Administrator','admin','$2a$08$K0ZBIwMMILQ2DjFkOKMi6.yKU1epzx9gE8kGok4pl2ZX4v6A62y8q',0);
...
--
-- Dumping events for database 'sanmiguel'
--

--
-- Dumping routines for database 'sanmiguel'
--
...
-- Dump completed on 2023-03-18 23:47:02
