...
CREATE TABLE `bookings` (
  ...
  `partner_dni` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `books` (
  ...
  `author` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'Desconocido',
  ...
  `collection` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `partners` (
  ...
  `scanner` varchar(25) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `name` varchar(45) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `lastname` varchar(45) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `direction` varchar(45) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `phone` int NOT NULL,
...
INSERT INTO `users` VALUES (1,'admin@mail.com','Admin','Admin','admin','$2a$08$ulm/CnZOsnK2QBZvGkUNhOwa7UAlgfW7vzve6UTipObobjc92rKxa',0);
...
CREATE TABLE `votes` (
  ...
  `review` varchar(4000) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`vote_id`),
  KEY `book_id` (`book_id`),
...
-- Dump completed on 2022-09-28 23:32:43
