                ...
                },
                {
                    ...
                    render: function (data, type) {
                        if (type === "display") {
                            if (data.reserved === 0) {
                                btnDisable =
                                    `<button id="btnReservedBook" onClick=reservedBook(` + data.bookID + `) class="btn btn-secondary" title="Reserved Book" style="cursor: pointer"><i class="fa-solid fa-calendar-days"></i></button>`;
                            } else {
